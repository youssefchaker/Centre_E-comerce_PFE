                ...
                /></div> :reviews.reviews.length!=0?
                                ...
                                {reviews.reviews.map((review,index)=>(
                                    ...
                                    <tr>
                                        ...
                                        <button className="fa fa-edit btn btn-primary py-1 px-2 ml-2" onClick={()=>this.openSearch("comment",review._id,review.rating)}></button>
                                        <button className="fa fa-star btn btn-secondary py-1 px-2 ml-2" onClick={()=>this.openSearch("rating",review._id,review.comment)}></button>
