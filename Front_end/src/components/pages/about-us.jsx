                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-sm-12">
                                <h4>WELCOME TO OUR E-COMMERCE MALL</h4>
                                <p>
...
Consumers will then be able to directly purchase products of their choice via the site, management and support services for entrepreneurship<br/>
via flexible functionalities will also be offered in the platform for sellers.</p>
                            </div>
                        </div>
                    </div>
                </section>
