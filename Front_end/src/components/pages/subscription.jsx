...
function Subscription ({history})  {
    ...
    const [buisnessDomaine, setBuisnessDomaine] = useState('');
                                    ...
                                    <div className="checkout row">
                                        <div className="col-lg-6 col-sm-12 col-xs-12">
                                            <div className="checkout-title">
                                                <h3>Subscription Details</h3><br></br>
                                            </div>
                                            <div className="row check-out">
                                                ...
                                                <div className="form-group col-md-12 col-sm-6 col-xs-12">
                                                    <div className="field-label" style={{border: '1px solid #ccc',display: 'inline-block', padding: '15px 20px', cursor: 'pointer', borderRadius: '3px', margin: '0.4em auto'}}>Store image :   <span><small>"910 x 310"</small></span></div>
                                                    <input type="file" className="form-control-file"  name="avatar"  onChange={onChangeImage} accept="image/*" />
                                                    {simpleValidator.current.message('avatar', avatar, 'required')}
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-6 col-sm-12 col-xs-12">
                                            <div className="checkout-details">
                                                ...
                                                <div className="payment-box">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <div className="radio-option stripe">
                                                                        ...
                                                                        <label htmlFor="payment-2">{payment}</label>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div className="text-right">
                                                     <button type="submit" className="btn-solid btn" onClick={processToPayment} >Buy Subscription</button>
